...
//import tec.AC40.Suite.OrderFlow_old;
...
public class Xls_Reader {
	...
	public static int SheetRowcount = 0;
	...
	public String getCellData(String sheetName, String colName, int rowNum) {
		try {
			...
			if (cell.getCellType() == Cell.CELL_TYPE_STRING) {
				...
				//System.out.println("Automation : " + cellText);
	...
	public String getCellData(String sheetName, int colNum, int rowNum) {
		try {
			...
			if (cell == null)
				return "";
			// System.out.println("satish------------ "+cell.toString());
			if (cell.getCellType() == Cell.CELL_TYPE_STRING) {
				// System.out.println("this is string "+Cell.CELL_TYPE_STRING);
				// System.out.println("satish "+cell.getCellType());
				
				String cellText1 = String.valueOf(cell.getStringCellValue());
	...
	public boolean addHyperLink(String sheetName, String screenShotColName,
			String testDataName, int index, String url, String message) {
		...
		for (int i = 2; i <= getRowCount(sheetName); i++) {
			if (getCellData(sheetName, 0, i).equalsIgnoreCase(testDataName)) {
